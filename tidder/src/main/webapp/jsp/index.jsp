...
<body ng-app="Tidder">
	...
	<div class="container-fluid" id="style-9">
		<div class="row content">
			...
			<!--    <div class="col-sm-9" ng-controller="MainPageController"> -->
			<div class="col-sm-9 mainPage" ng-controller="PaginationMyController"
				ng-init="init()">
				<h4>
				...
				<div class="comment" ng-repeat="x in dataPerPage track by $index">
					...
					<br>
					<p class="well">{{ x.text }}</p>
					<div class="col-xs-11">
						<div class="button">
							<!-- <span class="btn" ng-click="x.data = getCommentById(x.id)">View Comments</span> -->
							<span class="btn" ng-click="commentVisible = !commentVisible">View
								Comments</span>
